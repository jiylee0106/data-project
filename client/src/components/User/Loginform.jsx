        ...
        >
          <div className="flex items-center h-full px-20 bg-gray-900 bg-opacity-40">
            <div>
              ...
              <p className="max-w-2xl mt-3 text-gray-300 whitespace-pre-line">
                우리가 알고 있는 야생생물이 20분마다 1종씩 사라지고 있습니다.<br />
                가까운 곳에서 우리가 보호해야 할 멸종위기 야생생물이 살고 있습니다.<br />
                우리가 잘 모르는 동·식물이 어쩌면 멸종위기 야생생물일 수도 있습니다.<br />
                우리의 관심이 우리나라에 살고 있는 다양한 생물들을 지킬 수 있으며,<br />
