  ...
  return (
    <div className="flex-col lg:flex-row md:h-full md:h-auto p-6 border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700 flex items-center">
      <div className="w-full">
        <h5 className="main-font mb-2 pb-8 text-4xl font-bold tracking-tight text-gray-900 dark:text-white">
          {videoInfo?.title}
        </h5>

        <p className="main-font mb-3 pb-8 font-normal text-gray-700 dark:text-gray-400">
